        ...
        <>
            ...
            >
                ...
                <button
                    type="button"
                    onClick={() => navigate("/")}
                    className="absolute bottom-16 left-3 right-3 inline-flex items-center justify-center gap-1.5 rounded-md border border-zinc-800 bg-zinc-900 px-3 py-2 text-sm text-zinc-200 transition-colors hover:bg-zinc-800"
                >
