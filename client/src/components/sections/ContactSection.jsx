...
import { Briefcase, Code, Globe, Github, Linkedin, Twitter, Instagram, ExternalLink, Terminal, BookOpen, MessageSquare } from 'lucide-react';
...
const PROFILES = [
  {
    ...
    icon: Briefcase,
    items: [
      { name: 'LinkedIn', icon: Linkedin, url: 'https://linkedin.com/in/arif-ansari' },
      { name: 'GitHub', icon: Github, url: 'https://github.com/mohd-arif-ansari' },
      { name: 'Portfolio', icon: Globe, url: 'https://arif-ansari.vercel.app' },
    ],
  },
  {
    ...
    icon: Code,
    items: [
      { name: 'LeetCode', icon: Code, url: 'https://leetcode.com/arif-ansari' },
      { name: 'GeeksforGeeks', icon: BookOpen, url: 'https://auth.geeksforgeeks.org/user/arif_ansari' },
      { name: 'HackerRank', icon: Terminal, url: 'https://www.hackerrank.com/arif_ansari' },
    ],
  },
  {
    title: 'Social & More',
    icon: MessageSquare,
    items: [
      { name: 'X (Twitter)', icon: Twitter, url: 'https://x.com/arif_ansari' },
      { name: 'Instagram', icon: Instagram, url: 'https://instagram.com/arif_ansari' },
    ],
  },
];
...
const ContactSection = () => {
  ...
  return (
    <SectionWrapper id="contact" bgVariant="secondary" className="py-10 sm:py-16">
      <Container>
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
            {/* Contact Form */}
            <Card className="border-zinc-800 bg-zinc-950/75 p-5 sm:p-6" hoverEffect={false}>
              <form onSubmit={onSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  {form.formState.errors.name ? (
                    <p className="text-xs text-red-500/80">{form.formState.errors.name.message}</p>
                  ) : null}
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  {form.formState.errors.email ? (
                    <p className="text-xs text-red-500/80">{form.formState.errors.email.message}</p>
                  ) : null}
                </div>
                ...
                <div className="space-y-1.5 sm:col-span-2">
                  ...
                  {form.formState.errors.message ? (
                    <p className="text-xs text-red-500/80">{form.formState.errors.message.message}</p>
                  ) : null}
                </div>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-zinc-400">
                  Explore my work across professional and coding platforms.
                </p>
              </div>
