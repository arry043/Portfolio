          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-zinc-400">
                Full Stack Developer building scalable backend systems & AI-powered apps.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://github.com/arry043" target="_blank"
                  className="p-2 border border-zinc-800 rounded-md hover:bg-zinc-900 transition">
                  <Github className="w-4 h-4 text-zinc-400" />
                </a>

                <a href="https://linkedin.com/in/arryquerry" target="_blank"
                  className="p-2 border border-zinc-800 rounded-md hover:bg-zinc-900 transition">
                  <Linkedin className="w-4 h-4 text-zinc-400" />
                </a>

                <a href={`mailto:arifquerry@gmail.com`} target="_blank"
                  className="p-2 border border-zinc-800 rounded-md hover:bg-zinc-900 transition">
